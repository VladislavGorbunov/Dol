  ...
  <tbody>
        ...
        <?php
            foreach ($representatives as $represent) {
                ...
                <td><a href="/admin/representative/view/'. $represent['user_id'] .'">'. $represent['organization'] .'</a></td>
                <td>'. $represent['inn'] .'</td>
                <td>'. $represent['firstname_manager'] .' '. $represent['lastname_manager'] .'</td>
                <td>'. $represent['post'] .'</td>
                <td>'. $represent['phone_manager'] .'</td>
                <td><a href="/admin/representatives/camps/'. $represent['user_id'] .'">Смотреть</a></td>
              </tr>';
            }
        ?>
